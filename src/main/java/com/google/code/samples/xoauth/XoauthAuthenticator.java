...
public class XoauthAuthenticator {
	 ...
	 * called {@code initialize}.
	 * 
	 * @param host Hostname of the smtp server, for example
	...
	public static void main(String args[]) throws Exception {
		...
		// Generated with python xoauth.py --generate_oauth_token
		// --user=mvd7793@gmail.com

		String email = "mvd7793@gmail.com";
		String oauthToken = "1/LHRPLtjNrgEXqFL57ycPyDy1QVPgGlr3sAjLzZB1IY4";
		String oauthTokenSecret = "u83aHOZbRiuP6ACBmD3peZmz";

		initialize();

		IMAPSSLStore imapSslStore = connectToImap("imap.googlemail.com", 993, email, oauthToken, oauthTokenSecret, getAnonymousConsumer(), false);
		System.out.println("Successfully authenticated to IMAP.\n");
		SMTPTransport smtpTransport = connectToSmtp("smtp.googlemail.com", 587, email, oauthToken, oauthTokenSecret, getAnonymousConsumer(), false);

		Folder drafts = imapSslStore.getFolder("[Gmail]/Drafts");
		drafts.open(Folder.READ_WRITE);
		for (Message m : drafts.getMessages()) {
			Address[] toArray = m.getAllRecipients();
			System.out.println(Arrays.toString(m.getFrom()));
			System.out.println(Arrays.toString(toArray));
			smtpTransport.sendMessage(m, toArray);
		}
...
//
//		msg.setFrom(new InternetAddress("mvd7793@gmail.com"));
//		msg.addRecipient(Message.RecipientType.TO, new InternetAddress("mvd7793@gmail.com"));
//		msg.addRecipient(Message.RecipientType.CC, new InternetAddress("mvd7793.dev@gmail.com"));
//		msg.setSubject("Subject!");
//		msg.setText("This is the text of the message");
//
//		Address[] toArray = {};

//		smtpTransport.sendMessage(msg, toArray);
